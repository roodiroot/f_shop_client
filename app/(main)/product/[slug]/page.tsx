...
import { GET_PRODUCT_BY_ID, GET_PRODUCT_BY_SLUG } from "@/graphql/products";
import client from "@/lib/apollo-client";
import { getImageUrl } from "@/lib/get-image-url";
import { cn } from "@/lib/utils";
import { Product, ProductResponce } from "@/types/products";
        ...
        <div className="pt-6">
          ...
          <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-8 lg:px-8">
            <img
              ...
              src={getImageUrl(data?.products[0]?.images?.[0])}
              className="row-span-2 aspect-3/4 size-full rounded-lg object-cover max-lg:hidden"
            />
            <img
              alt={product.images[1].alt}
              src={getImageUrl(data?.products[0]?.images?.[1])}
              className="col-start-2 aspect-3/2 size-full rounded-lg object-cover max-lg:hidden"
            />
            <img
              alt={product.images[2].alt}
              src={getImageUrl(data?.products[0]?.images?.[2])}
              className="col-start-2 row-start-2 aspect-3/2 size-full rounded-lg object-cover max-lg:hidden"
            />
            <img
              alt={product.images[3].alt}
              src={getImageUrl(data?.products[0]?.images?.[3])}
              ...
              <div className="mt-10">
                ...
                <AddProductCartButton
                  product={{
                    ...
                    name:
                      data.products[0].categoryParam +
                      " " +
                      data.products[0].shortName,
