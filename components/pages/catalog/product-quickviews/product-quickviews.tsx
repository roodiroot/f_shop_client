...
const ProductQuickviews = () => {
  const { isOpen, close, product } = useProductQuickview();
                  ...
                  >
                    ...
                    <div className="mt-6">
                      ...
                      <div className="flex items-center">
                        ...
                        <p className="sr-only">
                          {productDEMO.rating} out of 5 stars
                        </p>
                        <a
                          href="#"
                          ...
                          {productDEMO.colors.map((color) => (
                            ...
                            >
                              <input
                                ...
                                defaultChecked={color === productDEMO.colors[0]}
                                name="color"
                                type="radio"
                          ...
                          {productDEMO.sizes.map((size) => (
                            ...
                            >
                              <input
                                ...
                                defaultChecked={size === productDEMO.sizes[2]}
                                name="size"
                                type="radio"
